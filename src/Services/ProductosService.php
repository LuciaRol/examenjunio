<?php
    ...
    class productosService{
        ...
        public function guardarProducto(int $categoria_id, string $nombreProducto, string $descripcion, float $precio): bool {
            return $this->productosRepository->guardarProducto($categoria_id, $nombreProducto, $descripcion, $precio);
        }
        ...
        public function editarProducto(int $productoId, int $categoria_id, string $nombreProducto, string $descripcion, float $precio): bool {
            return $this->productosRepository->editarProducto($productoId, $categoria_id, $nombreProducto, $descripcion, $precio);
        }
